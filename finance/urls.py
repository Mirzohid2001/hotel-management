...
urlpatterns = [
    ...
    path("chek/", views.expense_summary_print, name="summary_print"),
    path("new/", views.expense_create, name="create"),
    path("<int:pk>/chek/", views.expense_print, name="print"),
    ...
    path("profit/tarix/", views.profit_history, name="profit_history"),
    path("profit/tarix/<int:pk>/", views.profit_period_detail, name="profit_period_detail"),
